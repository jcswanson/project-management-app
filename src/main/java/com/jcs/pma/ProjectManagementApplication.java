...
public class ProjectManagementApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			// need to set both sides of the relationship manually using a convenience method
			...
			// need to set both sides of the relationship manually and bypass the convenience methods
